...
<head>
    ...
    <body>
        ...
        <div class="jumbotron">
            ...
            <p class="lead">This application will make you more comfortable in terms of getting your daily attendance so stay tuned!</p>
            <hr class="my-4">
        </div>
        <div class="container-fluid" id="div">
            <h5 style="color:white">Subjects and Faculty:</h5>
